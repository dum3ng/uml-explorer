...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51972__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51972__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__51995 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__51995__$1 = (((G__51995 == null))?null:cljs.core.persistent_BANG_(G__51995));
if((G__51995__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__51995__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__52007){
var vec__52010 = p__52007;
...
var frame = first__52012;
var frames = seq__52011__$1;
...
var results = (function (){var G__52027 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__52027,kvps);
} else {
return G__52027;
}
})();
...
var map__52039 = parent;
var map__52039__$1 = cljs.core.__destructure_map(map__52039);
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52039__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52039__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_52169 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_52169,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__52069){
...
var parent = first__52072;
var frames = seq__52071__$1;
...
var found = cljs.core.not_empty((function (){var G__52073 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__52073);
} else {
return G__52073;
}
})());
...
var as_value = (function (){var G__52074 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__52065_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__52065_SHARP_]);
}),G__52074);
} else {
return G__52074;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__52078 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__52078);
} else {
return G__52078;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__52079 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__52079,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__52079;
}
})());
...
var vec__52080 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52080,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52080,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__52083){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__52103){
...
var frame = first__52106;
var frames = seq__52105__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__52109){
var vec__52110 = p__52109;
var seq__52111 = cljs.core.seq(vec__52110);
var first__52112 = cljs.core.first(seq__52111);
var seq__52111__$1 = cljs.core.next(seq__52111);
var frame = first__52112;
var frames = seq__52111__$1;
...
var vec__52114 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52114,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52114,(1),null);
...
var map__52120 = frame;
var map__52120__$1 = cljs.core.__destructure_map(map__52120);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52120__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52120__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__52124 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__52124,attr,eid);
} else {
return G__52124;
}
})();
...
var map__52131 = frame;
var map__52131__$1 = cljs.core.__destructure_map(map__52131);
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52131__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52131__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__52132){
while(true){
...
var frame = first__52135;
var frames = seq__52134__$1;
var temp__5751__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5751__auto__){
var eids = temp__5751__auto__;
...
var G__52174 = db;
var G__52175 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__52174;
p__52132 = G__52175;
continue;
}
...
while(true){
var G__52141 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__52141__$1 = (((G__52141 instanceof cljs.core.Keyword))?G__52141.fqn:null);
switch (G__52141__$1) {
case "expand":
var G__52177 = db;
var G__52178 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__52177;
frames = G__52178;
continue;
...
case "expand-rev":
var G__52179 = db;
var G__52180 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__52179;
frames = G__52180;
continue;
...
case "pattern":
var G__52181 = db;
var G__52182 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__52181;
frames = G__52182;
continue;
...
case "recursion":
var G__52183 = db;
var G__52184 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__52183;
frames = G__52184;
continue;
...
var f = first__52144;
var remaining = seq__52143__$1;
var result = (function (){var G__52145 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__52145);
} else {
return G__52145;
}
})();
...
var G__52185 = db;
var G__52186 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__52147 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__52147,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__52147;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52141__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__52150_SHARP_){
return datascript.db.entid_strict(db,p1__52150_SHARP_);
})),eids);
