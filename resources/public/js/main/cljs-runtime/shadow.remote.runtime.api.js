...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_44816 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_44816(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_44824 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_44824(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_44831 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_44831(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_44838 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_44838(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_44852 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_44852(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_44857 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_44857(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__44799,callback){
var map__44800 = p__44799;
var map__44800__$1 = cljs.core.__destructure_map(map__44800);
var input = map__44800__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44800__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44800__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
