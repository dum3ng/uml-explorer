...
var len__4818__auto___41140 = arguments.length;
var i__4819__auto___41142 = (0);
while(true){
if((i__4819__auto___41142 < len__4818__auto___41140)){
args__4824__auto__.push((arguments[i__4819__auto___41142]));

var G__41143 = (i__4819__auto___41142 + (1));
i__4819__auto___41142 = G__41143;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41067){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41068,G__41069,seq41067__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41099_SHARP_){
return (!((cljs.core.meta(p1__41099_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41117__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41119){var _e__39901__auto__ = e41119;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e41122){var _e__39901__auto__ = e41122;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41126 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41127 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41127);

try{var map__41131 = opts;
var map__41131__$1 = cljs.core.__destructure_map(map__41131);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41131__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41126);
}});
...
var temp__5751__auto___41161 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___41161)){
var managed_print_level_41162 = temp__5751__auto___41161;
var _STAR_print_level_STAR__orig_val__41133_41163 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41134_41164 = managed_print_level_41162;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41134_41164);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41132_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41132_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41133_41163);
}} else {
job_fn();
}
