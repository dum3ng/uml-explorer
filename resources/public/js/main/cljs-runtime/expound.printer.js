...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49519_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__49519_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49523_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49523_SHARP_)));
}),row));
});
...
var G__49534 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__49535 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__49534,G__49535) : expound.printer.format.call(null,G__49534,G__49535));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49547_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49547_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49548_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49548_SHARP_)).length),"="));
}),header);
...
var iter__4611__auto__ = (function expound$printer$multirow_$_iter__49555(s__49556){
return (new cljs.core.LazySeq(null,(function (){
var s__49556__$1 = s__49556;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__49556__$1);
if(temp__5753__auto__){
var s__49556__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__49556__$2)){
var c__4609__auto__ = cljs.core.chunk_first(s__49556__$2);
var size__4610__auto__ = cljs.core.count(c__4609__auto__);
var b__49558 = cljs.core.chunk_buffer(size__4610__auto__);
if((function (){var i__49557 = (0);
while(true){
if((i__49557 < size__4610__auto__)){
var row_idx = cljs.core._nth(c__4609__auto__,i__49557);
cljs.core.chunk_append(b__49558,(function (){var iter__4611__auto__ = ((function (i__49557,row_idx,c__4609__auto__,size__4610__auto__,b__49558,s__49556__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__49555_$_iter__49561(s__49562){
return (new cljs.core.LazySeq(null,((function (i__49557,row_idx,c__4609__auto__,size__4610__auto__,b__49558,s__49556__$2,temp__5753__auto__,split_row_contents){
return (function (){
var s__49562__$1 = s__49562;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__49562__$1);
if(temp__5753__auto____$1){
var s__49562__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__49562__$2)){
var c__4609__auto____$1 = cljs.core.chunk_first(s__49562__$2);
var size__4610__auto____$1 = cljs.core.count(c__4609__auto____$1);
var b__49564 = cljs.core.chunk_buffer(size__4610__auto____$1);
if((function (){var i__49563 = (0);
while(true){
if((i__49563 < size__4610__auto____$1)){
var col_idx = cljs.core._nth(c__4609__auto____$1,i__49563);
cljs.core.chunk_append(b__49564,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__49816 = (i__49563 + (1));
i__49563 = G__49816;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49564),expound$printer$multirow_$_iter__49555_$_iter__49561(cljs.core.chunk_rest(s__49562__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49564),null);
}
} else {
var col_idx = cljs.core.first(s__49562__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__49555_$_iter__49561(cljs.core.rest(s__49562__$2)));
}
} else {
return null;
}
...
});})(i__49557,row_idx,c__4609__auto__,size__4610__auto__,b__49558,s__49556__$2,temp__5753__auto__,split_row_contents))
,null,null));
});})(i__49557,row_idx,c__4609__auto__,size__4610__auto__,b__49558,s__49556__$2,temp__5753__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49558),expound$printer$multirow_$_iter__49555(cljs.core.chunk_rest(s__49556__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49558),null);
}
} else {
var row_idx = cljs.core.first(s__49556__$2);
return cljs.core.cons((function (){var iter__4611__auto__ = ((function (row_idx,s__49556__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__49555_$_iter__49595(s__49596){
return (new cljs.core.LazySeq(null,(function (){
var s__49596__$1 = s__49596;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__49596__$1);
if(temp__5753__auto____$1){
var s__49596__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__49596__$2)){
var c__4609__auto__ = cljs.core.chunk_first(s__49596__$2);
var size__4610__auto__ = cljs.core.count(c__4609__auto__);
var b__49598 = cljs.core.chunk_buffer(size__4610__auto__);
if((function (){var i__49597 = (0);
while(true){
if((i__49597 < size__4610__auto__)){
var col_idx = cljs.core._nth(c__4609__auto__,i__49597);
cljs.core.chunk_append(b__49598,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__49821 = (i__49597 + (1));
i__49597 = G__49821;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49598),expound$printer$multirow_$_iter__49555_$_iter__49595(cljs.core.chunk_rest(s__49596__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49598),null);
}
} else {
var col_idx = cljs.core.first(s__49596__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__49555_$_iter__49595(cljs.core.rest(s__49596__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__49556__$2,temp__5753__auto__,split_row_contents))
;
return iter__4611__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__49555(cljs.core.rest(s__49556__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49606_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__49606_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__49643 = via;
var G__49643__$1 = (((G__49643 == null))?null:cljs.core.last(G__49643));
if((G__49643__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__49643__$1);
}
})();
...
var seq__49647_49843 = cljs.core.seq(problems);
var chunk__49648_49844 = null;
var count__49649_49845 = (0);
var i__49650_49846 = (0);
while(true){
if((i__49650_49846 < count__49649_49845)){
var p_49847 = chunk__49648_49844.cljs$core$IIndexed$_nth$arity$2(null,i__49650_49846);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_49847) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__49851 = seq__49647_49843;
var G__49852 = chunk__49648_49844;
var G__49853 = count__49649_49845;
var G__49854 = (i__49650_49846 + (1));
seq__49647_49843 = G__49851;
chunk__49648_49844 = G__49852;
count__49649_49845 = G__49853;
i__49650_49846 = G__49854;
continue;
} else {
var temp__5753__auto___49858 = cljs.core.seq(seq__49647_49843);
if(temp__5753__auto___49858){
var seq__49647_49859__$1 = temp__5753__auto___49858;
if(cljs.core.chunked_seq_QMARK_(seq__49647_49859__$1)){
var c__4638__auto___49860 = cljs.core.chunk_first(seq__49647_49859__$1);
var G__49861 = cljs.core.chunk_rest(seq__49647_49859__$1);
var G__49862 = c__4638__auto___49860;
var G__49863 = cljs.core.count(c__4638__auto___49860);
var G__49864 = (0);
seq__49647_49843 = G__49861;
chunk__49648_49844 = G__49862;
count__49649_49845 = G__49863;
i__49650_49846 = G__49864;
continue;
} else {
var p_49865 = cljs.core.first(seq__49647_49859__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_49865) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__49866 = cljs.core.next(seq__49647_49859__$1);
var G__49867 = null;
var G__49868 = (0);
var G__49869 = (0);
seq__49647_49843 = G__49866;
chunk__49648_49844 = G__49867;
count__49649_49845 = G__49868;
i__49650_49846 = G__49869;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__4212__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__49646_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__49646_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__49659){
var vec__49660 = p__49659;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49660,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49660,(1),null);
var G__49663 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49663__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__49666 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49666,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49666,(1),null);
var G__49672 = branch;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq49679){
var G__49680 = cljs.core.first(seq49679);
var seq49679__$1 = cljs.core.next(seq49679);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49680,seq49679__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49699_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__49699_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__49700_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__49700_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__49704){
var vec__49705 = p__49704;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49705,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49705,(1),null);
...
var _STAR_print_newline_STAR__orig_val__49709_49892 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__49710_49893 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__49711_49894 = true;
var _STAR_print_fn_STAR__temp_val__49712_49895 = (function (x__4750__auto__){
return sb__4749__auto__.append(x__4750__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__49711_49894);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__49712_49895);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__49710_49893);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__49709_49892);
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49718_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__49718_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__49736 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
var seq__49737 = cljs.core.seq(vec__49736);
var first__49738 = cljs.core.first(seq__49737);
var seq__49737__$1 = cljs.core.next(seq__49737);
var line = first__49738;
var lines = seq__49737__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49731_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49731_SHARP_)].join('');
}),lines)));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__49750 = show_valid_values_QMARK_;
var G__49751 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__49752 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__49750,G__49751,G__49752) : expound.printer.summary_form.call(null,G__49750,G__49751,G__49752));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__49913 = show_valid_values_QMARK_;
var G__49914 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__49915 = rst__$1;
show_valid_values_QMARK_ = G__49913;
form = G__49914;
in$ = G__49915;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__49753 = show_valid_values_QMARK_;
var G__49754 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__49755 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__49753,G__49754,G__49755) : expound.printer.summary_form.call(null,G__49753,G__49754,G__49755));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__49758 = show_valid_values_QMARK_;
var G__49759 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__49760 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__49758,G__49759,G__49760) : expound.printer.summary_form.call(null,G__49758,G__49759,G__49760));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__49761 = show_valid_values_QMARK_;
var G__49762 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__49763 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__49761,G__49762,G__49763) : expound.printer.summary_form.call(null,G__49761,G__49762,G__49763));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__49765 = show_valid_values_QMARK_;
var G__49766 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__49767 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__49765,G__49766,G__49767) : expound.printer.summary_form.call(null,G__49765,G__49766,G__49767));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49775_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49775_SHARP_)).length);
...
var map__49784 = problem;
var map__49784__$1 = cljs.core.__destructure_map(map__49784);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49784__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49784__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__49785 = opts;
var map__49785__$1 = cljs.core.__destructure_map(map__49785);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49785__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__49792 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__49793 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__49793);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__49792);
}})();
var vec__49786 = cljs.core.re_find(regex,s);
...
var line = first__49788;
var first__49788__$1 = cljs.core.first(seq__49787__$1);
var seq__49787__$2 = cljs.core.next(seq__49787__$1);
var prefix = first__49788__$1;
var _more = seq__49787__$2;
