...
if((!((next_attr == null)))){
var G__52161 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(attrs,next_attr);
attrs = G__52161;
continue;
} else {
 ...
 * avet     :: [<index in eavt> ...]
 */
datascript.serialize.serializable_impl = (function datascript$serialize$serializable_impl(db,p__52096){
var map__52097 = p__52096;
var map__52097__$1 = cljs.core.__destructure_map(map__52097);
var freeze_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52097__$1,new cljs.core.Keyword(null,"freeze-fn","freeze-fn",-575885995),cljs.core.pr_str);
...
var e = d.e;
var a = (function (){var G__52107 = d.a;
return (attrs_map.cljs$core$IFn$_invoke$arity$1 ? attrs_map.cljs$core$IFn$_invoke$arity$1(G__52107) : attrs_map.call(null,G__52107));
})();
var v = write_v(d.v);
...
var schema = (function (){var G__52108 = new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1(db);
return (freeze_fn.cljs$core$IFn$_invoke$arity$1 ? freeze_fn.cljs$core$IFn$_invoke$arity$1(G__52108) : freeze_fn.call(null,G__52108));
})();
...
var pred__52137 = cljs.core._EQ__EQ_;
var expr__52138 = marker;
if(cljs.core.truth_((pred__52137.cljs$core$IFn$_invoke$arity$2 ? pred__52137.cljs$core$IFn$_invoke$arity$2((0),expr__52138) : pred__52137.call(null,(0),expr__52138)))){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(keywords,datascript.serialize.array_get(v,(1)));
} else {
if(cljs.core.truth_((pred__52137.cljs$core$IFn$_invoke$arity$2 ? pred__52137.cljs$core$IFn$_invoke$arity$2((1),expr__52138) : pred__52137.call(null,(1),expr__52138)))){
var G__52140 = datascript.serialize.array_get(v,(1));
return (thaw_fn.cljs$core$IFn$_invoke$arity$1 ? thaw_fn.cljs$core$IFn$_invoke$arity$1(G__52140) : thaw_fn.call(null,G__52140));
} else {
...
var aevt = (function (){var G__52146 = datascript.serialize.dict_get(from,"aevt");
if((G__52146 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__52118_SHARP_){
return (eavt[p1__52118_SHARP_]);
}),G__52146);
}
})();
var avet = (function (){var G__52148 = datascript.serialize.dict_get(from,"avet");
if((G__52148 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__52119_SHARP_){
return (eavt[p1__52119_SHARP_]);
}),G__52148);
}
})();
return datascript.db.map__GT_DB(new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"rschema","rschema",-1196134054),(function (){var G__52152 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("db","ident","db/ident",-737096),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("db","unique","db/unique",329396388),new cljs.core.Keyword("db.unique","identity","db.unique/identity",1675950722)], null)], null),schema], 0));
var fexpr__52151 = new cljs.core.Var(function(){return datascript.db.rschema;},new cljs.core.Symbol("datascript.db","rschema","datascript.db/rschema",1982085018,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"datascript.db","datascript.db",-444456104,null),new cljs.core.Symbol(null,"rschema","rschema",444397473,null),"datascript/db.cljc",15,1,686,686,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"schema","schema",58529736,null)], null)),":db/unique           => #{attr ...}\n   :db.unique/identity  => #{attr ...}\n   :db.unique/value     => #{attr ...}\n   :db/index            => #{attr ...}\n   :db.cardinality/many => #{attr ...}\n   :db.type/ref         => #{attr ...}\n   :db/isComponent      => #{attr ...}\n   :db.type/tuple       => #{attr ...}\n   :db/attrTuples       => {attr => {tuple-attr => idx}}",(cljs.core.truth_(datascript.db.rschema)?datascript.db.rschema.cljs$lang$test:null)]));
return (fexpr__52151.cljs$core$IFn$_invoke$arity$1 ? fexpr__52151.cljs$core$IFn$_invoke$arity$1(G__52152) : fexpr__52151.call(null,G__52152));
