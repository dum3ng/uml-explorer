...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (adds,p__45222){
var vec__45223 = p__45222;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45223,(0),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (rems,p__45247){
var vec__45249 = p__45247;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45249,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45249,(1),null);
var temp__5751__auto__ = cljs.core.find(b,k);
if(cljs.core.truth_(temp__5751__auto__)){
var vec__45254 = temp__5751__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45254,(0),null);
var vb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45254,(1),null);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(rems,(function (){var G__45259 = k;
if(cljs.core.map_QMARK_(k)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45259,new cljs.core.Keyword("fulcro.inspect.lib.diff","key?","fulcro.inspect.lib.diff/key?",325118813),true);
} else {
return G__45259;
}
})());
...
com.fulcrologic.fulcro.inspect.diff.patch_updates = (function com$fulcrologic$fulcro$inspect$diff$patch_updates(x,p__45269){
var map__45270 = p__45269;
var map__45270__$1 = cljs.core.__destructure_map(map__45270);
var updates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45270__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","updates","fulcro.inspect.lib.diff/updates",221795125));
...
com.fulcrologic.fulcro.inspect.diff.patch_removals = (function com$fulcrologic$fulcro$inspect$diff$patch_removals(x,p__45274){
var map__45275 = p__45274;
var map__45275__$1 = cljs.core.__destructure_map(map__45275);
var removals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45275__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439));
...
var vec__45277 = cljs.core.first(rem);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(final$,k,(function (p1__45271_SHARP_){
var G__45281 = p1__45271_SHARP_;
var G__45282 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439),v], null);
return (com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2(G__45281,G__45282) : com.fulcrologic.fulcro.inspect.diff.patch_removals.call(null,G__45281,G__45282));
}));
} else {
