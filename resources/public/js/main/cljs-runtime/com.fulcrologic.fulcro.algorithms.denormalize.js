 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__55124){
var vec__55126 = p__55124;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55126,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55126,(1),null);
var ref = vec__55126;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__55131){
var vec__55133 = p__55131;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55133,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55133,(1),null);
var ref = vec__55133;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__55145){
var map__55147 = p__55145;
var map__55147__$1 = cljs.core.__destructure_map(map__55147);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55147__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__55166,entity,state_map,parent_node,idents_seen){
var map__55168 = p__55166;
var map__55168__$1 = cljs.core.__destructure_map(map__55168);
var join_node = map__55168__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55168__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55168__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__55178,entity,state_map,idents_seen){
var map__55179 = p__55178;
var map__55179__$1 = cljs.core.__destructure_map(map__55179);
var join_node = map__55179__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55179__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__55181){
var map__55182 = p__55181;
var map__55182__$1 = cljs.core.__destructure_map(map__55182);
var node = map__55182__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55182__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__55183 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55183,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var e = temp__5751__auto__;
var temp__5751__auto____$1 = (function (){var G__55188 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__55188) : union_key__GT_query.call(null,G__55188));
})();
if(cljs.core.truth_(temp__5751__auto____$1)){
var target_ast_node = temp__5751__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__55195,current_entity,state_map,idents_seen){
var map__55196 = p__55195;
var map__55196__$1 = cljs.core.__destructure_map(map__55196);
var top_node = map__55196__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55196__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55196__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__4210__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__55200 = nil_nodes;
var G__55200__$1 = (((G__55200 == null))?null:cljs.core.first(G__55200));
if((G__55200__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__55200__$1);
}
})());
} else {
return and__4210__auto__;
...
var G__55202 = result_node__$1;
var G__55202__$1 = (((G__55202 == null))?null:cljs.core.persistent_BANG_(G__55202));
if((G__55202__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__55202__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__55205 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__55205 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__55205,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__55209 = props;
var G__55209__$1 = (((G__55209 == null))?null:cljs.core.meta(G__55209));
if((G__55209__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__55209__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__55211 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__55212 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__55212);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__55211);
}});
/**
...
var map__55213 = cljs.core.meta(prior_props);
var map__55213__$1 = cljs.core.__destructure_map(map__55213);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55213__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55213__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
