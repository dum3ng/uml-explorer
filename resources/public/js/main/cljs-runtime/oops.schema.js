...
var G__54453 = cljs.core.first(element_str);
switch (G__54453) {
case "?":
arr.push((1));
...
var G__54488 = cljs.core.next(items);
items = G__54488;
continue;
} else {
return null;
...
var G__54493 = cljs.core.next(items);
items = G__54493;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__54472 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__54472) : is_valid_QMARK_.call(null,G__54472));
})())){
var G__54496 = cljs.core.next(cljs.core.next(items));
items = G__54496;
continue;
} else {
return true;
...
switch (G__54479) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__54476_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__54476_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__54477_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__54477_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__54479)].join('')));
