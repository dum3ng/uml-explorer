...
var G__41063 = devtools.prefs.pref(v);
v = G__41063;
continue;
} else {
return v;
...
}catch (e41021){var _e__39901__auto__ = e41021;
return false;
}})();
...
}catch (e41024){var _e__39901__auto__ = e41024;
return false;
}})();
...
}catch (e41026){var _e__39901__auto__ = e41026;
return false;
}}
}
});
...
var vec__41048 = devtools.munging.parse_constructor_info(constructor_fn);
...
return cljs.core.some((function (p1__41051_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41051_SHARP_);
}),template);
});
