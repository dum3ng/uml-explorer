...
var G__54481 = cljs.core.next(items);
items = G__54481;
continue;
} else {
return arr;
...
var x54456 = error;
(x54456.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x54456.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (_obj,writer,opts){
var _obj__$1 = this;
...
var G__54485 = Object.getPrototypeOf(o);
o = G__54485;
continue;
} else {
