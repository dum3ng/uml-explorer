 ...
 */
com.fulcrologic.fulcro.raw.application.update_shared_BANG_ = (function com$fulcrologic$fulcro$raw$application$update_shared_BANG_(p__61658){
var map__61659 = p__61658;
var map__61659__$1 = cljs.core.__destructure_map(map__61659);
var app = map__61659__$1;
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61659__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61671__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61671__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var map__61672 = cljs.core.deref(runtime_atom);
var map__61672__$1 = cljs.core.__destructure_map(map__61672);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61672__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
var indexes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61672__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","indexes","com.fulcrologic.fulcro.application/indexes",-165326938));
...
(com.fulcrologic.fulcro.raw.application.render_BANG_.cljs$core$IFn$_invoke$arity$2 = (function (app,p__61700){
var map__61701 = p__61700;
var map__61701__$1 = cljs.core.__destructure_map(map__61701);
var options = map__61701__$1;
var force_root_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61701__$1,new cljs.core.Keyword(null,"force-root?","force-root?",-1598741683));
com.fulcrologic.fulcro.raw.application.tick_BANG_(app);

var map__61703 = app;
var map__61703__$1 = cljs.core.__destructure_map(map__61703);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61703__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61703__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var map__61704 = (function (){var G__61705 = runtime_atom;
if((G__61705 == null)){
return null;
} else {
return cljs.core.deref(G__61705);
}
})();
var map__61704__$1 = cljs.core.__destructure_map(map__61704);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61704__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
if(cljs.core.truth_(root_class)){
var core_render_BANG__61872 = com.fulcrologic.fulcro.algorithms.lookup.app_algorithm(app,new cljs.core.Keyword(null,"core-render!","core-render!",1128819499));
var root_props_changed_QMARK__61873 = com.fulcrologic.fulcro.raw.application.root_props_changed_QMARK_(app);
if(cljs.core.truth_((function (){var or__4212__auto__ = force_root_QMARK_;
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return root_props_changed_QMARK__61873;
}
})())){
...
if(cljs.core.truth_(core_render_BANG__61872)){
var G__61707_61874 = app;
var G__61708_61875 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([options,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"root-props-changed?","root-props-changed?",1999614835),root_props_changed_QMARK__61873], null)], 0));
(core_render_BANG__61872.cljs$core$IFn$_invoke$arity$2 ? core_render_BANG__61872.cljs$core$IFn$_invoke$arity$2(G__61707_61874,G__61708_61875) : core_render_BANG__61872.call(null,G__61707_61874,G__61708_61875));
} else {
}
...
var seq__61710 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("com.fulcrologic.fulcro.application","render-listeners","com.fulcrologic.fulcro.application/render-listeners",-684979123).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(runtime_atom))));
var chunk__61711 = null;
var count__61712 = (0);
var i__61713 = (0);
while(true){
if((i__61713 < count__61712)){
var render_listener = chunk__61711.cljs$core$IIndexed$_nth$arity$2(null,i__61713);
...
}catch (e61718){var e_61876 = e61718;
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.raw.application",null,115,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (seq__61710,chunk__61711,count__61712,i__61713,e_61876,render_listener,batch_notifications,map__61703,map__61703__$1,runtime_atom,state_atom,map__61704,map__61704__$1,root_class,map__61701,map__61701__$1,options,force_root_QMARK_){
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [e_61876,"Render listener failed. See https://book.fulcrologic.com/#err-render-listener-failed"], null);
});})(seq__61710,chunk__61711,count__61712,i__61713,e_61876,render_listener,batch_notifications,map__61703,map__61703__$1,runtime_atom,state_atom,map__61704,map__61704__$1,root_class,map__61701,map__61701__$1,options,force_root_QMARK_))
,null)),null,-1951964521,null);
}

var G__61877 = seq__61710;
var G__61878 = chunk__61711;
var G__61879 = count__61712;
var G__61880 = (i__61713 + (1));
seq__61710 = G__61877;
chunk__61711 = G__61878;
count__61712 = G__61879;
i__61713 = G__61880;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__61710);
if(temp__5753__auto__){
var seq__61710__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__61710__$1)){
var c__4638__auto__ = cljs.core.chunk_first(seq__61710__$1);
var G__61881 = cljs.core.chunk_rest(seq__61710__$1);
var G__61882 = c__4638__auto__;
var G__61883 = cljs.core.count(c__4638__auto__);
var G__61884 = (0);
seq__61710 = G__61881;
chunk__61711 = G__61882;
count__61712 = G__61883;
i__61713 = G__61884;
continue;
} else {
var render_listener = cljs.core.first(seq__61710__$1);
try{(render_listener.cljs$core$IFn$_invoke$arity$2 ? render_listener.cljs$core$IFn$_invoke$arity$2(app,options) : render_listener.call(null,app,options));
}catch (e61720){var e_61885 = e61720;
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$11(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.raw.application",null,115,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (seq__61710,chunk__61711,count__61712,i__61713,e_61885,render_listener,seq__61710__$1,temp__5753__auto__,batch_notifications,map__61703,map__61703__$1,runtime_atom,state_atom,map__61704,map__61704__$1,root_class,map__61701,map__61701__$1,options,force_root_QMARK_){
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [e_61885,"Render listener failed. See https://book.fulcrologic.com/#err-render-listener-failed"], null);
});})(seq__61710,chunk__61711,count__61712,i__61713,e_61885,render_listener,seq__61710__$1,temp__5753__auto__,batch_notifications,map__61703,map__61703__$1,runtime_atom,state_atom,map__61704,map__61704__$1,root_class,map__61701,map__61701__$1,options,force_root_QMARK_))
,null)),null,-1683997062,null);
}

var G__61886 = cljs.core.next(seq__61710__$1);
var G__61887 = null;
var G__61888 = (0);
var G__61889 = (0);
seq__61710 = G__61886;
chunk__61711 = G__61887;
count__61712 = G__61888;
i__61713 = G__61889;
continue;
}
} else {
...
var go_BANG__61890 = goog.functions.debounce((function (app,options){
...
return (go_BANG__61890.cljs$core$IFn$_invoke$arity$2 ? go_BANG__61890.cljs$core$IFn$_invoke$arity$2(app,options) : go_BANG__61890.call(null,app,options));
}));
 ...
 *   map is not 200.
 */
com.fulcrologic.fulcro.raw.application.default_remote_error_QMARK_ = (function com$fulcrologic$fulcro$raw$application$default_remote_error_QMARK_(p__61760){
var map__61761 = p__61760;
var map__61761__$1 = cljs.core.__destructure_map(map__61761);
var status_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61761__$1,new cljs.core.Keyword(null,"status-code","status-code",-1060410130));
...
var ns = (function (){var G__61806 = k;
if((G__61806 == null)){
return null;
} else {
return kw_namespace(G__61806);
}
})();
var ident_ns = ((edn_query_language.core.ident_QMARK_(k))?(function (){var G__61807 = cljs.core.first(k);
if((G__61807 == null)){
return null;
} else {
return kw_namespace(G__61807);
}
})():null);
...
(com.fulcrologic.fulcro.raw.application.fulcro_app.cljs$core$IFn$_invoke$arity$1 = (function (p__61839){
var map__61840 = p__61839;
var map__61840__$1 = cljs.core.__destructure_map(map__61840);
var options = map__61840__$1;
var default_result_action_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"default-result-action!","default-result-action!",-622954374));
var external_config = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"external-config","external-config",-471423941));
var batch_notifications = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"batch-notifications","batch-notifications",1250364860));
var global_error_action = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"global-error-action","global-error-action",-924822372));
var render_middleware = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"render-middleware","render-middleware",1183628797));
var unmount_root_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"unmount-root!","unmount-root!",1516744861));
var client_did_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"client-did-mount","client-did-mount",-958324226));
var initial_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"initial-db","initial-db",1939835102));
var query_transform_default = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"query-transform-default","query-transform-default",-1684574273));
var props_middleware = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"props-middleware","props-middleware",358176739));
var load_mutation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"load-mutation","load-mutation",-2132703225));
var remotes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"remotes","remotes",1132366312));
var core_render_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"core-render!","core-render!",1128819499));
var client_will_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"client-will-mount","client-will-mount",-2138714037));
var hydrate_root_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"hydrate-root!","hydrate-root!",-184171028));
var global_eql_transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"global-eql-transform","global-eql-transform",145441548));
var shared_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"shared-fn","shared-fn",-180260144));
var load_marker_default = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"load-marker-default","load-marker-default",335781105));
var render_root_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"render-root!","render-root!",820937651));
var optimized_render_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"optimized-render!","optimized-render!",1504010964));
var submit_transaction_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"submit-transaction!","submit-transaction!",554065589));
var abort_transaction_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"abort-transaction!","abort-transaction!",-1430666634));
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"root-class","root-class",-267672298));
var remote_error_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"remote-error?","remote-error?",-391127497));
var shared = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61840__$1,new cljs.core.Keyword(null,"shared","shared",-384145993));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61845,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.tx-processing","after-render","com.fulcrologic.fulcro.algorithms.tx-processing/after-render",349495132),com.fulcrologic.fulcro.algorithms.tx_processing.application_rendered_BANG_);
} else {
return G__61845;
}
...
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"remote","remote",-1593576576),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"transmit!","transmit!",-107149039),(function (p__61846){
var map__61847 = p__61846;
var map__61847__$1 = cljs.core.__destructure_map(map__61847);
var result_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61847__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.tx-processing","result-handler","com.fulcrologic.fulcro.algorithms.tx-processing/result-handler",-114902209));
...
}),null)),null,1710660849,null);

var G__61848 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"status-code","status-code",-1060410130),(418),new cljs.core.Keyword(null,"body","body",-2049205669),cljs.core.PersistentArrayMap.EMPTY], null);
return (result_handler.cljs$core$IFn$_invoke$arity$1 ? result_handler.cljs$core$IFn$_invoke$arity$1(G__61848) : result_handler.call(null,G__61848));
})], null)], null);
}
})(),null]))], null);
}));
 ...
 *   
 */
com.fulcrologic.fulcro.raw.application.maybe_merge_new_root_BANG_ = (function com$fulcrologic$fulcro$raw$application$maybe_merge_new_root_BANG_(app,root_key,component,p__61858){
var map__61859 = p__61858;
var map__61859__$1 = cljs.core.__destructure_map(map__61859);
var keep_existing_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61859__$1,new cljs.core.Keyword(null,"keep-existing?","keep-existing?",-916245180));
var initial_params = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__61859__$1,new cljs.core.Keyword(null,"initial-params","initial-params",1980851682),cljs.core.PersistentArrayMap.EMPTY);
var initialize_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61859__$1,new cljs.core.Keyword(null,"initialize?","initialize?",-1238334118));
if(cljs.core.truth_((function (){var and__4210__auto__ = initialize_QMARK_;
if(cljs.core.truth_(and__4210__auto__)){
return cljs.core.not((function (){var and__4210__auto____$1 = keep_existing_QMARK_;
 ...
 *   
 */
com.fulcrologic.fulcro.raw.application.add_root_BANG_ = (function com$fulcrologic$fulcro$raw$application$add_root_BANG_(app,root_key,component,p__61861){
var map__61862 = p__61861;
var map__61862__$1 = cljs.core.__destructure_map(map__61862);
var options = map__61862__$1;
var receive_props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61862__$1,new cljs.core.Keyword(null,"receive-props","receive-props",-391890642));
var initialize_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61862__$1,new cljs.core.Keyword(null,"initialize?","initialize?",-1238334118));
var keep_existing_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61862__$1,new cljs.core.Keyword(null,"keep-existing?","keep-existing?",-916245180));
var initial_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61862__$1,new cljs.core.Keyword(null,"initial-params","initial-params",1980851682));
...
var G__61864_61902 = get_props();
(receive_props.cljs$core$IFn$_invoke$arity$1 ? receive_props.cljs$core$IFn$_invoke$arity$1(G__61864_61902) : receive_props.call(null,G__61864_61902));
 ...
 *   
 */
com.fulcrologic.fulcro.raw.application.maybe_merge_new_component_BANG_ = (function com$fulcrologic$fulcro$raw$application$maybe_merge_new_component_BANG_(app,component,component_data,p__61866){
var map__61867 = p__61866;
var map__61867__$1 = cljs.core.__destructure_map(map__61867);
var keep_existing_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61867__$1,new cljs.core.Keyword(null,"keep-existing?","keep-existing?",-916245180));
var initialize_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__61867__$1,new cljs.core.Keyword(null,"initialize?","initialize?",-1238334118),true);
if(cljs.core.truth_((function (){var and__4210__auto__ = initialize_QMARK_;
if(cljs.core.truth_(and__4210__auto__)){
return cljs.core.not((function (){var and__4210__auto____$1 = keep_existing_QMARK_;
if(cljs.core.truth_(and__4210__auto____$1)){
 ...
 *   
 */
com.fulcrologic.fulcro.raw.application.add_component_BANG_ = (function com$fulcrologic$fulcro$raw$application$add_component_BANG_(app,component,p__61868){
var map__61869 = p__61868;
var map__61869__$1 = cljs.core.__destructure_map(map__61869);
var options = map__61869__$1;
var receive_props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61869__$1,new cljs.core.Keyword(null,"receive-props","receive-props",-391890642));
var initialize_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61869__$1,new cljs.core.Keyword(null,"initialize?","initialize?",-1238334118));
var keep_existing_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61869__$1,new cljs.core.Keyword(null,"keep-existing?","keep-existing?",-916245180));
var initial_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61869__$1,new cljs.core.Keyword(null,"initial-params","initial-params",1980851682));
...
var ident = (function (){var or__4212__auto__ = new cljs.core.Keyword(null,"ident","ident",-742346).cljs$core$IFn$_invoke$arity$1(options);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
...
var G__61870_61908 = get_props();
(receive_props.cljs$core$IFn$_invoke$arity$1 ? receive_props.cljs$core$IFn$_invoke$arity$1(G__61870_61908) : receive_props.call(null,G__61870_61908));
