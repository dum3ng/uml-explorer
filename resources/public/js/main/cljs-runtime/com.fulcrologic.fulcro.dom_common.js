...
var id = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58131_SHARP_){
return cljs.core.re_matches(/^#.*/,p1__58131_SHARP_);
}),tokens));
var classes = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58132_SHARP_){
return cljs.core.re_matches(/^\..*/,p1__58132_SHARP_);
}),tokens);
...
var G__58133 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(com.fulcrologic.fulcro.dom_common.remove_separators,classes))], null);
if(cljs.core.truth_(sanitized_id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58133,new cljs.core.Keyword(null,"id","id",-1388402092),sanitized_id);
} else {
return G__58133;
}
} else {
...
var map__58134 = com.fulcrologic.fulcro.dom_common.parse(kw);
var map__58134__$1 = cljs.core.__destructure_map(map__58134);
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58134__$1,new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.PersistentVector.EMPTY);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58134__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var G__58137 = (function (){var or__4212__auto__ = props;
...
var G__58137__$1 = ((cljs.core.seq(classes))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58137,new cljs.core.Keyword(null,"className","className",-1983287057),com.fulcrologic.fulcro.dom_common.combined_classes(classes,existing_classes)):G__58137);
if(cljs.core.truth_(id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58137__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__58137__$1;
}
}
